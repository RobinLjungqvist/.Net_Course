...
<body>
    ...
    <div>
        ...
        <br />                                                  
        <asp:Button ID="Button4" runat="server" Text="4" Width="70px" />
        <asp:Button ID="Button5" runat="server" Text="5" Width="70px" />
        <asp:Button ID="Button6" runat="server" Text="6" Width="70px" />
        <asp:Button ID="ButtonSub" runat="server" Text="-" Width="70px" />

        <br />                                                  
        <asp:Button ID="Button7" runat="server" Text="7" Width="70px" />
        <asp:Button ID="Button8" runat="server" Text="8" Width="70px" />
        <asp:Button ID="Button9" runat="server" Text="9" Width="70px" />
        <asp:Button ID="ButtonMulti" runat="server" Text="*" Width="70px" />

        <br />
        <asp:Button ID="Button_C" runat="server" Text="C" Width="70px" />
        <asp:Button ID="Button0" runat="server" Text="0" Width="70px" />
        <asp:Button ID="ButtonEqual" runat="server" Text="=" Width="70px" />
